...
Перевод результата в выбранную систему счисления:
Результат операции переводится из десятичной системы в выбранную пользователем систему счисления с помощью функции translate_to.
